export class FormGenerator {
  constructor () {
    ...
    for (i=0; i<3; i++) {
      inputString=inputString + '<input type="{FIELD_TYPE}" id="{FIELD_NAME}[' + i + ']" name="{FIELD_NAME}" class="form-control m-b" value="{VALUE' + i + '}"> \ '
    }
    ...
    for (i=0; i<3; i++) {
      spanString=spanString + '<span id="{FIELD_NAME}[' + i + ']" name="{FIELD_NAME}">{VALUE'+ i +'}</span> \ '
    }
